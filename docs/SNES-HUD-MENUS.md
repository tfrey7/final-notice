...
*`kb_get snes-hud-menus-introduction` · version 1*
...
*`kb_get snes-hud-menus-readable-at-a-glance` · version 2*
...
*`kb_get snes-hud-menus-placement-and-screen-real-estate` · version 2*
...
*`kb_get snes-hud-menus-what-to-show-what-to-hide-and-when` · version 2*
...
*`kb_get snes-hud-menus-feedback-and-animation` · version 2*
...
*`kb_get snes-hud-menus-colour-and-contrast-on-busy-backgrounds` · version 2*
...
*`kb_get snes-hud-menus-how-the-hardware-shaped-all-of-this` · version 2*
...
*`kb_get snes-hud-menus-the-snes-games-with-the-best-huds-and-menus` · version 2*
...
*`kb_get snes-hud-menus-how-distinctive-menus-make-a-game-stand-out` · version 2*
...
*`kb_get snes-hud-menus-our-current-screens-against-the-findings` · version 2*
...
*`kb_get snes-hud-menus-recommendation-for-final-notice` · version 2*
...
*`kb_get snes-hud-menus-hud-in-play` · version 2*
...
*`kb_get snes-hud-menus-pause-and-inventory` · version 3*
...
*`kb_get snes-hud-menus-select` · version 2*
...
*`kb_get snes-hud-menus-title-flow` · version 2*
...
*`kb_get snes-hud-menus-what-not-to-do` · version 2*
...
*`kb_get snes-hud-menus-the-build-as-cards-under-epic-1898` · version 1*
...
*`kb_get snes-hud-menus-sources` · version 1*
