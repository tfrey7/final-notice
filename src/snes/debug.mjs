...
const BACKGROUNDS = { claims: CLAIMS, claims2: CLAIMS2, reception: RECEPTION };
...
export const DEBUG_ROUTES = [
  ...
  { flag: 'hud', scene: SnesHudScene, what: 'HUD in scripted play, Streets of Rage 2 style: face icon and lives, name and score over the health bar, Notice meter, enchantments, boss bar; the health lost to a hit shows red then drains' },
