...
const I = {
  ...
  kick: { sample: 'gkick', adsr: [15, 7, 7, 0], vol: 110 },
  ...
  orch: { sample: 'orch', adsr: [15, 7, 7, 0], vol: 120, echo: true },
  ...
  lead: { sample: 'sqlead', adsr: [15, 7, 7, 0], vol: 60, echo: true },
  leadEcho: { sample: 'sqlead', adsr: [15, 7, 7, 0], vol: 28, pan: 40, echo: true },
  bell: { sample: 'bell', adsr: [15, 5, 3, 16], vol: 100, echo: true },
  bellEcho: { sample: 'bell', adsr: [15, 5, 3, 16], vol: 44, pan: -40, echo: true },
  keys: { sample: 'epiano', adsr: [15, 5, 3, 16], vol: 90, echo: true },
  brass: { sample: 'brass', adsr: [15, 3, 5, 12], vol: 90, echo: true },
  sax: { sample: 'sax', adsr: [15, 4, 5, 10], vol: 90, echo: true },
  bass: { sample: 'synbass', adsr: [15, 4, 3, 14], vol: 120 },
