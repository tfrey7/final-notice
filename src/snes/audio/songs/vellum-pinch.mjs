...
import vellum, { A_CHORDS, A_LEAD, BAR_ROWS, B_CHORDS, B_LEAD_2, INSTRUMENTS_USED, arrange, keyed } from './vellum.mjs';
import { bars } from './chase-kit.mjs';

export const SHIFT = 2;
export const FORM = [...keyed('A', A_CHORDS, A_LEAD, SHIFT), ...keyed('B', B_CHORDS, B_LEAD_2, SHIFT)];
