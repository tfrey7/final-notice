...
export default {
  ...
  echo: { mvol: 26, evol: 30, efb: 92, edl: 7, fir: [12, 33, 43, 43, 19, -2, -13, -7] },
  instruments: {
    lead: { ...INSTRUMENTS.strings, vol: 118, pan: -40, pitch: vibrato(0.22, 15, 14) },
    horn: { ...INSTRUMENTS.brass, adsr: [12, 3, 6, 6], vol: 70, pan: 80, pitch: vibrato(0.18, 15, 18) },
    ...
    chat: { ...INSTRUMENTS.chat, vol: 28, pan: 50 },
    ohat: { ...INSTRUMENTS.ohat, vol: 24, pan: -36 },
  },
