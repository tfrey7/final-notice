...
const INSTRUMENTS = {
  lead: { sample: 'sqlead', adsr: [14, 6, 6, 10], vol: 58, pan: -10, echo: true },
  chime: { sample: 'bell', adsr: [15, 5, 2, 17], vol: 112, echo: true },
  harm: { sample: 'epiano', adsr: [15, 4, 4, 16], vol: 70, pan: 20, echo: true },
  bell: { sample: 'bell', adsr: [15, 5, 1, 19], vol: 48, pan: -35, echo: true },
  beep: { sample: 'sqlead', adsr: [15, 7, 7, 0], vol: 60 },
  echo: { sample: 'sqlead', adsr: [15, 7, 7, 0], vol: 26, pan: 40, echo: true },
  drop: { sample: 'sqlead', adsr: [15, 6, 5, 12], vol: 62, pitch: fall(-12, 12) },
  dropEcho: { sample: 'sqlead', adsr: [15, 6, 5, 12], vol: 26, pan: 40, echo: true, pitch: fall(-12, 12) },
  sad: { sample: 'sax', adsr: [13, 6, 6, 8], vol: 92, echo: true },
  busy: { sample: 'sqlead', adsr: [15, 7, 7, 0], vol: 48 },
  dial: { sample: 'sqlead', adsr: [15, 7, 7, 0], vol: 40 },
  brass: { sample: 'brass', adsr: [12, 3, 5, 12], vol: 78, echo: true },
  stab: { sample: 'brass', adsr: [15, 3, 2, 18], vol: 88 },
  pad: { sample: 'pad', adsr: [5, 2, 6, 0], vol: 46, echo: true },
  fall: { sample: 'brass', adsr: [15, 4, 4, 14], vol: 80, pitch: slide(0.5) },
  bass: { sample: 'synbass', adsr: [15, 2, 5, 14], vol: 110 },
  bassFall: { sample: 'synbass', adsr: [15, 2, 5, 14], vol: 110, pitch: slide(0.3) },
  hat: { sample: 'chat', adsr: [15, 7, 7, 0], vol: 90, pan: 24 },
  fax: { noise: 28, adsr: [15, 7, 7, 0], vol: 36, pan: -24 },
  kick: { sample: 'gkick', adsr: [15, 7, 7, 0], vol: 120 },
  snare: { sample: 'gsnare', adsr: [15, 7, 7, 0], vol: 116, echo: true },
  ks: { sample: 'gkick', adsr: [15, 7, 7, 0], vol: 127 },
  orch: { sample: 'orch', adsr: [15, 7, 7, 0], vol: 110, echo: true },
